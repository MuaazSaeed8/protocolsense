...
const LandingPage: React.FC<LandingPageProps> = ({ onSignIn, onTryFree }) => {
  return (
        ...
        <div className="max-w-2xl w-full text-center space-y-6 relative z-10">
          ...
          <div className="flex flex-col items-center gap-3 pt-2">
            <div className="flex flex-col sm:flex-row items-center gap-3">
              <button
                onClick={onTryFree}
                className="flex items-center gap-2 bg-gradient-to-r from-primary to-aiPurple text-background px-6 py-3 rounded-full text-base font-bold hover:opacity-90 transition-all shadow-lg shadow-primary/20"
              >
            ...
            <p className="text-sm text-on-surface-variant/50">No credit card required · 1 free analysis, no sign-in needed</p>
          </div>
        </div>
      </div>
